...
**Todavía pendiente — iOS/App Store (sin cuenta pagada todavía):**
...
- appleId + ascAppId + appleTeamId (o API key) para completar `submit.production` en `eas.json` — ninguno existe todavía, esperando que se acredite el pago de la cuenta Apple Developer.
...
- App Privacy questionnaire de App Store Connect — completar cuando exista la ficha, usando `/privacidad` y lo ya declarado en Data Safety de Google como referencia.
