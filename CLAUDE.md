...
11. **Pendiente:** confirmación de los testers reales sobre build 7 (más allá del test en persona de Agus). Hay una submission completa a App Store (no sólo TestFlight) que quedó **cancelada** desde que apuntaba al build 3 buggy — pendiente de resubmit ahora que el fix real está confirmado.
...
- Confirmación de los testers de que el build 6 resuelve el freeze (ver arriba).
- Resubmit de la versión completa a App Store (cancelada, esperando esa confirmación).
...
**Próximo paso:**
- **Esperar confirmación de los testers** de que el build 6 de iOS ya no se cuelga, y recién ahí resubmitir la versión completa a App Store.
- **Armar el track de Closed Testing en Play Console** y avisarle a los 14 testers que instalen y abran la app de verdad (no alcanza con estar en la lista) — es lo que arranca el reloj de 14 días hacia Producción.
