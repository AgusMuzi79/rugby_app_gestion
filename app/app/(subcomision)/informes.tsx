...
const s = StyleSheet.create({
  ...
  cargandoTexto: { fontFamily: fonts.cuerpo, color: MUTED, fontSize: 15 },
  ...
  pillTexto:       { fontFamily: fonts.label, color: MUTED, fontSize: 14, fontWeight: '500' },
  ...
  seccionTitulo:     { fontFamily: fonts.label, fontSize: 13, letterSpacing: 1.5, color: colors.oro, fontWeight: '700', textTransform: 'uppercase' },
  seccionTituloMt:   { fontFamily: fonts.label, fontSize: 13, letterSpacing: 1.5, color: colors.oro, fontWeight: '700', textTransform: 'uppercase', marginTop: 12 },
  seccionTotal:      { fontFamily: fonts.cuerpo, fontSize: 14, color: MUTED },
  vacio:             { fontFamily: fonts.cuerpo, color: MUTED, fontSize: 15, fontStyle: 'italic', paddingVertical: 4 },
  gap4:              { gap: 4 },

  divHeader:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 8, paddingHorizontal: 2 },
  divHeaderTexto: { fontFamily: fonts.cuerpo, fontSize: 15, fontWeight: '700', color: TEXTO, letterSpacing: 0.3 },
  ...
  cardNombre: { fontFamily: fonts.cuerpo, fontSize: 16, fontWeight: '600', color: TEXTO, flex: 1, marginRight: 8 },
  cardNombreResult: { fontFamily: fonts.cuerpo, fontSize: 16, fontWeight: '600', color: TEXTO, flex: 1, marginRight: 0, marginLeft: 8 },
  cardMuted:  { fontFamily: fonts.cuerpo, fontSize: 14, color: MUTED },
  cardFecha:  { fontFamily: fonts.cuerpo, fontSize: 14, color: MUTED },
  cardDiv:    { fontFamily: fonts.label, fontSize: 13, color: colors.oro, letterSpacing: 0.5 },

  badgeRojo:  { backgroundColor: ROJO, borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2 },
  badgeTexto: { fontFamily: fonts.label, color: '#FFF', fontSize: 13, fontWeight: '700', letterSpacing: 0.5 },

  porcNum:    { fontFamily: fonts.cuerpo, fontSize: 19, fontWeight: '700', minWidth: 44, textAlign: 'right' },
  ...
  wld:    { fontFamily: fonts.label, fontSize: 14, fontWeight: '700', letterSpacing: 0.5 },
  wldW:   { color: VERDE },
  wldL:   { color: ROJO },
  wldD:   { color: colors.oro },

  resBadge:      { width: 30, height: 30, borderRadius: 15, justifyContent: 'center', alignItems: 'center' },
  resBadgeTexto: { fontFamily: fonts.label, fontSize: 13, fontWeight: '700', color: '#FFF' },
  resW:          { backgroundColor: VERDE },
  resL:          { backgroundColor: ROJO },
  resD:          { backgroundColor: colors.oro },
  marcador:      { fontFamily: fonts.cuerpo, fontSize: 19, fontWeight: '700', color: TEXTO, marginHorizontal: 6 },

  numGrande: { fontFamily: fonts.cuerpo, fontSize: 25, fontWeight: '700', color: TEXTO },

  tipoBadge: { borderWidth: 1.5, borderRadius: 4, paddingHorizontal: 8, paddingVertical: 2 },
  tipoTexto: { fontFamily: fonts.label, fontSize: 13, fontWeight: '700', letterSpacing: 0.5 },
  cobrado:   { fontFamily: fonts.cuerpo, fontSize: 15, fontWeight: '600', color: TEXTO },
  ...
  formaTexto: { fontFamily: fonts.label, fontSize: 13, color: TEXTO },
})
