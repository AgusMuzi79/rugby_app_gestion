...
const s = StyleSheet.create({
  ...
  seccionLabel: { fontFamily: fonts.label, fontSize: 13, letterSpacing: 2, color: colors.oro, textTransform: 'uppercase', marginBottom: 4 },
  ...
  cardTitulo:     { flex: 1, fontFamily: fonts.cuerpo, fontSize: 17, fontWeight: '700', color: colors.tinta },
  cardFecha:      { fontFamily: fonts.cuerpo, fontSize: 13, color: '#8E8574' },
  cardMensaje:    { fontFamily: fonts.cuerpo, fontSize: 15, color: '#8E8574', lineHeight: 18 },
  cardFooter:     { flexDirection: 'row', alignItems: 'center', marginTop: 2 },
  cardFooterIcon: { marginRight: 4 },
  cardDestinatarios: { fontFamily: fonts.cuerpo, fontSize: 13, color: '#8E8574' },
  ...
  rolBtnTexto:       { fontFamily: fonts.label, fontSize: 13, color: '#8E8574', fontWeight: '600', letterSpacing: 0.5 },
  ...
  btnEnviarTexto:    { fontFamily: fonts.label, color: colors.oro, fontSize: 14, letterSpacing: 2.5, fontWeight: '600' },
})
