    ...
    Tables: {
      ...
      noticias: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "noticias_division_id_fkey"
            columns: ["division_id"]
            isOneToOne: false
            referencedRelation: "divisiones"
            referencedColumns: ["id"]
      ...
      pagos_socios: {
        ...
        Relationships: [
          {
            foreignKeyName: "pagos_socios_cuota_id_fkey"
            columns: ["cuota_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "pagos_socios_socio_id_fkey"
            columns: ["socio_id"]
            isOneToOne: false
            referencedRelation: "socios"
            referencedColumns: ["id"]
      ...
      socio_servicios: {
        ...
        Relationships: [
          {
            foreignKeyName: "socio_servicios_servicio_id_fkey"
            columns: ["servicio_id"]
            isOneToOne: false
            referencedRelation: "servicios_opcionales"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "socio_servicios_socio_id_fkey"
            columns: ["socio_id"]
            isOneToOne: false
            referencedRelation: "socios"
            referencedColumns: ["id"]
      ...
      socios: {
        Row: {
          ...
          mp_card_retries: number
          mp_card_retry_at: string | null
      ...
      socios_secrets: {
        ...
        Relationships: [
          {
            foreignKeyName: "socios_secrets_socio_id_fkey"
            columns: ["socio_id"]
            isOneToOne: true
            referencedRelation: "socios"
            referencedColumns: ["id"]
