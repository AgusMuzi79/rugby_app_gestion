...
export default function Sidebar({ nombre, rol }: Props) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-56 border-r border-gris-claro flex flex-col z-20" style={{ backgroundColor: '#0B0905', borderColor: '#2C2418' }}>
