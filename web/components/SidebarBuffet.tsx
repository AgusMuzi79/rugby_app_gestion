...
const NAV = [
  { href: '/buffet/promos', label: 'Promos' },
]
...
export default function SidebarBuffet({ nombre }: Props) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-56 border-r flex flex-col z-20" style={{ backgroundColor: '#0B0905', borderColor: '#2C2418' }}>
      ...
      <div className="px-6 py-8 border-b border-gris-claro">
        ...
        <p className="font-lora text-gris text-[9px] tracking-[4px] mt-1.5 uppercase">Buffet</p>
      </div>
